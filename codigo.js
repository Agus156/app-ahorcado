...
window.onload = function(){
	 ...
	 var juego = function(){
		var letra = ["Culebra","Ballena","Anguila","Pez Leon","Delfin",
		"Pez Espada","Mantarrallas","Megalodon","Cangrejo","Pulpo",
		"Caballito de mar","Almeja","Estrella Marina","Planton","Calamar",
		"Pez Payaso","Medusa","Rana","Cocodrilo","Esponja","Anguila",
		"Serpiente marina", "charales", "pez globo", "tiburon", "tiburon martillo", "tortuga", 
		"foca", "pepinillo de mar",
		];
		var rnd, largo;
